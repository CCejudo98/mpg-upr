...
# ==========================================
# BALANCES BRUTALISTAS DE GRIS OXFORD (SISTEMA 2)
# ==========================================
st.markdown("---")
...
if e_in_real > 0:
    if i_destroyed > e_in_real:
        ...
        label_maint = "🛡️ Mantenimiento Técnico / NLP Leyes (%):" if foco_metabolico != "Logística y Suministros (Termodinámica Comercial)" else "🛡️ Seguridad de Inventario y Rutas (%):"
        label_assets = "📈 Reserva de Activos Reales (%):" if foco_metabolico != "Riesgo Regulatorio y Compliance (Motor de Fragilidad)" else "📈 Fondo Legal Indexado Preventivo (%):"
        label_slack = "🌪️ Holgura / Cobertura GAFI y Red (%):"
        ...
        if porcentaje_resiliencia_total > 90:
            ...
            st.error(f"⚠️ ERROR DE ASIGNACIÓN: La resiliencia total ({porcentaje_resiliencia_total}%) es peligrosamente baja. El capital fijo se degradará.")
        else:
            nivel_sancion = 0
